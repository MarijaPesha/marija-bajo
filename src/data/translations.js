  ...
  bhs: {
    ...
    about: {
      desc: [
        ...
        "Dolazi iz malog mjesta u Bosni i Hercegovini gdje je njeno odrastanje bilo usko vezano uz muzičko obrazovanje. Usprkos teškim poslijeratnim vremenima, predanost umjetnosti pružala joj je utjehu i inspiraciju, te razvijala kreativnost.",
      ],
      hidden: [
    ...
    contact: {
      desc: [
        "Zdravo,",
        "zaintrigirani, nadahnuti ili jednostavno želite podijeliti svoje misli?",
      ],
