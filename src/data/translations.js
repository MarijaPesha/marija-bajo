export const translations = {
  en: {
    ...
    about: {
      desc: [
        "Marija Bajo is a cultural worker and performing artist, dedicated to bringing creative concepts to life on stage. Her intention is bringing a fresh perspective to the classical and contemporary realms of music.",
        "Originally from a small place in Bosnia and Herzegovina, her upbringing was closely tied to music education. Despite the tough post-war times, her dedication to the arts gave her comfort and inspiration, fostering her creativity.",
      ],
      hidden: [
  ...
  //
  bhs: {
    nav: [[".MARIJA_BAJO", ".MCMLXXXIX"], "o autoru", "kontakt"],
    home: {
      title: "u inat tami",
      desc: "U inat tami je projekt koji kroz multimedijalni performans priča priču o (ne)kulturi sjećanja na Rat u Bosni i Hercegovini. Ova izvedba objedinjuje raznolikost različitih umjetničkih izričaja pri čemu se muzika ističe kao najdominantniji oblik.Uz izvedbu klavirskih kompozicija, tu su i elementi recitacije sastavljeni od činjenične historijske dokumentacije ratnih zločina, projekcije fotografija i audio snimaka.Ideja za projekt nastala je tokom proslave Beethovenova 250. rođendana u Bonnu. Bajo je bila inspirirana Beethovenovom borbom. Usprkos tome što je patio od gluhoće, komponirao je Odu radosti, duboko ljudsko postignuće koje je s njom duboko odjeknulo, posebno u svjetlu moderne historije njene zemlje i ljudskog iskustva. Beethovenove teškoće potaknule su je da shvati važnost prenošenja historijskih istina kroz muziku na svjež način. Potom je pratila različite znakove na putu, poput susreta s Josipom Magdićem u Zagrebu, koji joj je dao note za Sarajevske ratne razglednice i ispričao njihovu pozadinsku priču. Potom se njena izvedba postpuno razvijala u oblik koji sada utjelovljuje.",
    },
    about: {
      desc: [
        "Marija Bajo je kulturna radnica i izvođačica posvećena oživljavanju kreativnih koncepata na pozornici. Njena je namjera unošenje svježe perspektive u klasičnu i suvremenu muziku.",
        "Dolazi iz malog mjesta u Bosni i Hercegovini gdje je njeno odrastanje bilo usko vezano uz muzičko obrazovanje. Usprkos teškim poslijeratnim vremenima, njena joj je predanost umjetnosti pružala utjehu i inspiraciju te razvijala kreativnost.",
      ],
      hidden: [
        "Obraz se promijenio. Nutrina se vazda vidi na licu, ",
        "ako znamo gledati.",
        " No, mi smo premazali ogledala,nismo li krasni?",
      ],
    },
    contact: {
      desc: [
        "Zdravo,",
        "Zainteresirani, nadahnuti ili jednostavno želite podijeliti svoje misli?",
      ],
