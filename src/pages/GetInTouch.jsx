...
const buttonStyles =
  "mx-auto flex rounded border border-gray-700 bg-[#02021e] py-2 px-12 text-lg text-[#ececec] hover:bg-gray-900 hover:border-white focus:outline-none";
